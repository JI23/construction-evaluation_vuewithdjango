# Generated by Django 2.1 on 2018-08-12 15:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('median', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='中位值')),
                ('variance', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='方差')),
                ('lost_parameter', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='损失参数')),
                ('rehabilitation_coeffcient', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='修复系数')),
                ('min_rehab_cost', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='最小工程量折减数量(修复费用)')),
                ('min_lost_cost', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='工程量折减系数(修复费用)')),
                ('max_rehab_cost', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='最大工程量折减数量(修复费用)')),
                ('max_lost_cost', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='工程量折减系数(修复费用)')),
                ('cov_cost', models.DecimalField(decimal_places=4, max_digits=8, verbose_name='费用COV')),
                ('repair_people_day', models.IntegerField(verbose_name='修复时间(人*天)')),
                ('min_rehab_time', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='最小工程量折减数量(修复时间)')),
                ('min_lost_time', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='工程量折减系数(修复时间)')),
                ('max_rehab_time', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='最大工程量折减数量(修复时间)')),
                ('max_lost_time', models.DecimalField(decimal_places=2, max_digits=5, verbose_name='工程量折减系数(修复时间)')),
                ('cov_time', models.DecimalField(decimal_places=4, max_digits=8, verbose_name='时间COV')),
            ],
            options={
                'verbose_name': '易损件损伤',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('denfense_intensity', models.DecimalField(decimal_places=1, max_digits=2, verbose_name='设防烈度')),
                ('part_type', models.CharField(choices=[('0', 'zero'), ('1', 'one'), ('2', 'two'), ('3', 'three'), ('4', 'four')], default='0', max_length=1, verbose_name='场地类别')),
                ('number', models.SmallIntegerField(verbose_name='地震波数')),
                ('group', models.SmallIntegerField(verbose_name='地震分组')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('earchquake_wave_file', models.FileField(upload_to='<django.db.models.fields.related.ForeignKey>/%Y/%m/%d/', verbose_name='地震波文件')),
            ],
            options={
                'verbose_name': '地震波详情',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_floor', models.SmallIntegerField(verbose_name='起始楼层')),
                ('stop_floor', models.SmallIntegerField(verbose_name='终止楼层')),
                ('X', models.SmallIntegerField(verbose_name='X方向偏移')),
                ('Y', models.SmallIntegerField(verbose_name='Y方向偏移')),
                ('Non', models.SmallIntegerField(verbose_name='无方向偏移')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BTESDB.Project')),
            ],
            options={
                'verbose_name': '结构响应',
