    ...
    <div>
        ...
        <el-table-column prop="order1" label="易损性编号" width="150">
            <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.id" placeholder="点击可选" @focus="chooseId(scope.$index, tableData)"></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="order1" width="80" label="单位" >
            <template slot-scope="scope">
                <el-input size="small" disabled v-model="scope.row.unit"></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="order2" width="80"  label="起始楼层">
            <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.start_floor" placeholder="请输入内容"></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="order2" width="80"  label="终止楼层">
            <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.stop_floor" placeholder="请输入内容"></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="order2" width="130" label="x方向易损性数量">
            <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.X" placeholder="请输入内容"></el-input>
            </template>
        </el-table-column>
        <el-table-column prop="order2" width="130" label="y方向易损性数量">
            <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.Y" placeholder="请输入内容"></el-input>
            </template>
        </el-table-column>
            <el-table-column prop="order2" width="140" label="无方向易损性数量">
            <template slot-scope="scope">
                <el-input size="small"  v-model="scope.row.Non" placeholder="请输入内容"></el-input>
            </template>
        </el-table-column>
        <el-table-column
            fixed="right"
