<template>
    <div>
        ...
        <el-form :model="buildingForm" :rules="rules" ref="buildingForm">
        <el-col :span="24" class="step2">
            ...
            <!-- <el-date-picker type="date" style="width:90%" size='small' placeholder="请选择时间"  v-model="figure_time"></el-date-picker> -->
            ...
            <el-input style="width:90%" size='small' v-model.number="buildingForm.cost_per_squaremeter" auto-complete="off" placeholder="请输入内容"></el-input>
            </el-form-item>
